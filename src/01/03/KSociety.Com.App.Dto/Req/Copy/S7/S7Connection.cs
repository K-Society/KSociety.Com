...
namespace KSociety.Com.App.Dto.Req.Copy.S7
{
    [ProtoContract]
    public class S7Connection : IRequest
    {
        ...
        [ProtoMember(6)] public int? CpuTypeId { get; set; }

        [ProtoMember(7)] public short? Rack { get; set; }

        [ProtoMember(8)] public short? Slot { get; set; }

        [ProtoMember(9)] public int? ConnectionTypeId { get; set; }
