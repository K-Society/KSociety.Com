...
public class QueryListGridView : Module
{
    protected override void Load(ContainerBuilder builder)
    {
        ...
        builder.RegisterType<KSociety.Com.Srv.Agent.Query.S7.List.GridView.S7Connection>()
            .As<KSociety.Com.Srv.Agent.Interface.Query.S7.List.GridView.IS7Connection>().SingleInstance();

        builder.RegisterType<KSociety.Com.Srv.Agent.Query.S7.List.GridView.S7Tag>()
            .As<KSociety.Com.Srv.Agent.Interface.Query.S7.List.GridView.IS7Tag>().SingleInstance();
