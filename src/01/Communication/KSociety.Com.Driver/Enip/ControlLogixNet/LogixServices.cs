...
namespace KSociety.Com.Driver.Enip.ControlLogixNet
{
    internal class LogixServices
    {
        ...
        public static ReadDataServiceRequest BuildLogixReadDataRequest(string tagAddress, ushort number,
            out int requestSize)
        {
        ...
        public static ReadDataServiceRequest BuildLogixReadDataRequestFragment(string tagAddress, ushort number,
            out int requestSize)
        {
            byte[] newIOI = Ioi.BuildIOI(tagAddress);
        ...
        public static ReadDataServiceRequest BuildShortReadDataRequest(uint tagInstance, ushort number, ushort size,
            out int requestSize)
        {
            ...
            addData[3] = 0x01;
            addData[4] = 0x01;
            addData[5] = (byte)(size & 0xFF);
            addData[6] = (byte)((size & 0xFF00) >> 8);
            addData[7] = 0x03;
            addData[8] = 0x20;
            addData[9] = 0x6B;
        ...
        public static ReadDataServiceRequest BuildFragmentedReadDataRequest(string tagAddress, ushort number,
            uint offset, out int requestSize)
        {
            byte[] newIOI = Ioi.BuildIOI(tagAddress);
        ...
        public static ReadDataServiceReply ReadLogixDataFragmented(SessionInfo si, string tagAddress,
            ushort elementCount, uint byteOffset, object syncRoot) //ToDo syncRoot
        {
            int requestSize = 0;
            ReadDataServiceRequest request =
                BuildFragmentedReadDataRequest(tagAddress, elementCount, byteOffset, out requestSize);
            ...
            rrData.CPF.DataItem =
                CommonPacketItem.GetConnectedDataItem(request.Pack(), SequenceNumberGenerator.SequenceNumber(syncRoot));
            rrData.Timeout = 2000;
        ...
        public static ReadDataServiceReply ReadLogixDataFragment(SessionInfo si, string tagAddress, ushort elementCount,
            object syncRoot) //ToDo syncRoot
        {
            int requestSize = 0;
            ReadDataServiceRequest request =
                BuildLogixReadDataRequestFragment(tagAddress, elementCount, out requestSize);
...
#else
        public static WriteDataServiceRequest BuildLogixWriteDataRequest(string tagAddress, ushort dataType,
            ushort elementCount, byte[] data, ushort structHandle = 0x0000)
#endif
        {
            byte[] newIOI = Ioi.BuildIOI(tagAddress);
...
#else
        public static WriteDataServiceRequest BuildFragmentedWriteRequest(string tagAddress, ushort dataType,
            ushort elementCount, uint offset, byte[] data, ushort structHandle = 0x0000)
#endif
        {
            byte[] newIOI = Ioi.BuildIOI(tagAddress);
...
#else
        public static WriteDataServiceReply WriteLogixData(SessionInfo si, string tagAddress, ushort dataType,
                ushort elementCount, byte[] data, object syncRoot, ushort structHandle = 0x0000) //ToDo syncRoot
#endif
        {
            WriteDataServiceRequest request =
                BuildLogixWriteDataRequest(tagAddress, dataType, elementCount, data, structHandle);
