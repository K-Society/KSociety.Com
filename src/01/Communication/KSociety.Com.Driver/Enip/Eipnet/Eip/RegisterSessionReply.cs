...
namespace KSociety.Com.Driver.Enip.Eipnet.Eip
{
    ...
    /// </summary>
    public abstract class RegisterSessionReply
    {
        /// <summary>
        ...
        public static implicit operator RegisterSessionReply(EncapsReply reply)
        {
    ...
    /// </summary>
    public class RegisterSession_Success : RegisterSessionReply
    {
    ...
    /// </summary>
    public class RegisterSession_Failure : RegisterSessionReply
    {
