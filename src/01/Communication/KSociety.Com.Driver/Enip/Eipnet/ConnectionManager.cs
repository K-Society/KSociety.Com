...
namespace KSociety.Com.Driver.Enip.Eipnet
{
    ...
    public static class ConnectionManager
    {
...
#endif
        {
            ...
            EncapsReply response = MessageRouter.SendMR_Request(si, (byte)ConnectionManagerService.ForwardOpen,
                CommonPaths.ConnectionManager,
                fwdRequest.Pack());
        ...
        public static bool ForwardClose(SessionInfo si, byte[] Path)
        {
            ...
            EncapsReply response = MessageRouter.SendMR_Request(si, (byte)ConnectionManagerService.ForwardClose,
                CommonPaths.ConnectionManager,
                request.Pack());
