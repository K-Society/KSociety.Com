...
public class Query : IQuery
{
    ...
    public Srv.Dto.Common.List.Tag Tag(/*bool enabledOnly*/CallContext context = default)
    {
    ...
    public Srv.Dto.Common.List.Tag TagByGroupId(GroupId groupId, CallContext context = default)
    {
        throw new NotImplementedException();
    }

    public Srv.Dto.Common.List.Tag TagByGroupName(GroupName groupName, CallContext context = default)
    {
        throw new NotImplementedException();
    }
    ...
    public Srv.Dto.Common.List.Tag TagByGroupId(/*bool enabledOnly,*/ Guid groupId, CallContext context = default)
    {
        _logger.LogTrace("Query: " + GetType().FullName + "." + System.Reflection.MethodBase.GetCurrentMethod()?.Name);
        //if (enabledOnly)
        //{
    ...
    public Srv.Dto.Common.List.Tag TagByGroupName(/*bool enabledOnly,*/ string groupName, CallContext context = default)
    {
        _logger.LogTrace("Query: " + GetType().FullName + "." + System.Reflection.MethodBase.GetCurrentMethod()?.Name);
        //if (enabledOnly)
        //{
    ...
    public Srv.Dto.Common.List.TagGroup TagGroup(/*bool enabledOnly*/CallContext context = default)
    {
        _logger.LogTrace("Query: " + GetType().FullName + "." + System.Reflection.MethodBase.GetCurrentMethod()?.Name);
        //if (enabledOnly)
        //{
    ...
    public Srv.Dto.Common.List.Connection Connection(CallContext context = default)
    {
        _logger.LogTrace("Query: " + GetType().FullName + "." + System.Reflection.MethodBase.GetCurrentMethod()?.Name);
