...
namespace KSociety.Com.Srv.Dto.S7.Model
{
    ...
    {
        [ProtoMember(1)] public S7.S7Tag S7TagDto { get; set; }
        ...
        //
        [ProtoMember(7)] public ListKeyValuePair<int, string> AreaId { get; set; }

        [ProtoMember(8)] public ListKeyValuePair<int, string> WordLenId { get; set; }

        [ProtoMember(9)] public ListKeyValuePair<byte, string> BitOfByte { get; set; }
