...
namespace KSociety.Com.Pre.Web.App.Bindings.S7
{
    public class QueryListGridView : Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<Model.Class.Query.S7.List.GridView.S7Connection>()
                .As<Model.Interface.Query.S7.List.GridView.IS7Connection>().SingleInstance();

            builder.RegisterType<Model.Class.Query.S7.List.GridView.S7Tag>()
                .As<Model.Interface.Query.S7.List.GridView.IS7Tag>().SingleInstance();
