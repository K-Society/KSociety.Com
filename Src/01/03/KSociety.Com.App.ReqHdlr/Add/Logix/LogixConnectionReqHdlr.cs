...
namespace KSociety.Com.App.ReqHdlr.Add.Logix
{
        ...
        IRequestHandlerWithResponseAsync<LogixConnection, KSociety.Com.App.Dto.Res.Add.Logix.LogixConnection>
    {
        ...
        public LogixConnectionReqHdlr(ILoggerFactory loggerFactory, IDbUnitOfWork unitOfWork, IConnection connectionRepository, IMapper mapper)
        {
        ...
        public async ValueTask<KSociety.Com.App.Dto.Res.Add.Logix.LogixConnection> ExecuteAsync(LogixConnection request, CancellationToken cancellationToken = default)
        {
            ...
            return await _unitOfWork.CommitAsync(cancellationToken).ConfigureAwait(false) == -1
                ? new KSociety.Com.App.Dto.Res.Add.Logix.LogixConnection(Guid.Empty)
                : new KSociety.Com.App.Dto.Res.Add.Logix.LogixConnection(logixConnection.Id);
        }
    }
}
