...
using KSociety.Com.App.Dto.Req.Copy.S7;
using KSociety.Com.Domain.Repository.S7;
using Microsoft.Extensions.Logging;

namespace KSociety.Com.App.ReqHdlr.Copy.S7
{
    public class S7ConnectionReqHdlr :
        IRequestHandlerWithResponse<S7Connection, KSociety.Com.App.Dto.Res.Copy.S7.S7Connection>,
        IRequestHandlerWithResponseAsync<S7Connection, KSociety.Com.App.Dto.Res.Copy.S7.S7Connection>
    {
        ...
        public KSociety.Com.App.Dto.Res.Copy.S7.S7Connection Execute(S7Connection request)
        {
            var s7Connection =_mapper.Map<Domain.Entity.S7.S7Connection>(request);
            _connectionRepository.Add(s7Connection);
            return _unitOfWork.Commit() == -1 ? new KSociety.Com.App.Dto.Res.Copy.S7.S7Connection(Guid.Empty) : new KSociety.Com.App.Dto.Res.Copy.S7.S7Connection(s7Connection.Id);
        }
