...
namespace KSociety.Com.Srv.Host.Bindings.S7
{
    public class QueryModel : Module
    {
        ...
        {
            builder.RegisterType<Srv.Behavior.Query.S7.Query>().As<Srv.Contract.Query.S7.IQuery>();
            builder.RegisterType<Srv.Behavior.Query.S7.QueryAsync>().As<Srv.Contract.Query.S7.IQueryAsync>();
