...
namespace KSociety.Com.Srv.Dto.View.Joined
{
    ...
    public class AllConnection : IObject
    {
        ...
        [ProtoMember(3)] public string AutomationName { get; set; }
        ...
        [ProtoMember(8)] public int CpuTypeId { get; set; }

        [ProtoMember(9)] public string CpuTypeName { get; set; }

        [ProtoMember(10)] public int Rack { get; set; }

        [ProtoMember(11)] public int Slot { get; set; }

        [ProtoMember(12)] public int ConnectionTypeId { get; set; }

        [ProtoMember(13)] public string ConnectionTypeName { get; set; }
