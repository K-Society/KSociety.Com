...
namespace KSociety.Com.Srv.Dto.Common
{
        ...
        App.Dto.Req.Copy.Common.Tag>
    {
        ...
        {
            return new App.Dto.Req.Add.Common.Tag(AutomationTypeId, Name, ConnectionId, Enable, InputOutput,
                AnalogDigitalSignal, MemoryAddress, Invoke, TagGroupId);
        }

        public App.Dto.Req.Update.Common.Tag GetUpdateReq()
        {
            return new App.Dto.Req.Update.Common.Tag(Id, AutomationTypeId, Name, ConnectionId, Enable, InputOutput,
                AnalogDigitalSignal, MemoryAddress, Invoke, TagGroupId);
        }

        public App.Dto.Req.Copy.Common.Tag GetCopyReq()
        {
            return new App.Dto.Req.Copy.Common.Tag(AutomationTypeId, Name, ConnectionId, Enable, InputOutput,
                AnalogDigitalSignal, MemoryAddress, Invoke, TagGroupId);
        }
    }
}