...
namespace KSociety.Com.Srv.Dto.S7.Model
{
    ...
    {
        [ProtoMember(1)] public S7.S7Connection S7ConnectionDto { get; set; }

        [ProtoMember(2)] public ListKeyValuePair<int, string> AutomationTypeId { get; set; }

        [ProtoMember(3)] public ListKeyValuePair<int, string> ConnectionTypeId { get; set; }

        [ProtoMember(4)] public ListKeyValuePair<int, string> CpuTypeId { get; set; }
