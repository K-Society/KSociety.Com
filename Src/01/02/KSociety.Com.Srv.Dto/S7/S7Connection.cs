...
{
    [ProtoContract]
    public class S7Connection : IKbAppDtoObject<
        ...
        App.Dto.Req.Copy.S7.S7Connection>
    {
        ...
        {
            return new App.Dto.Req.Add.S7.S7Connection(AutomationTypeId, Name, Ip, Enable, WriteEnable, CpuTypeId, Rack, Slot, ConnectionTypeId);
        }

        public App.Dto.Req.Update.S7.S7Connection GetUpdateReq()
        {
            return new App.Dto.Req.Update.S7.S7Connection(Id, AutomationTypeId, Name, Ip, Enable, WriteEnable, CpuTypeId, Rack, Slot, ConnectionTypeId);
        }

        public App.Dto.Req.Copy.S7.S7Connection GetCopyReq()
        {
            return new App.Dto.Req.Copy.S7.S7Connection(AutomationTypeId, Name, Ip, Enable, WriteEnable, CpuTypeId, Rack, Slot, ConnectionTypeId);
        }
    }
}
