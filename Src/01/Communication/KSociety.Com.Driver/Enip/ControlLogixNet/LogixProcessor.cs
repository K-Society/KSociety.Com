...
namespace KSociety.Com.Driver.Enip.ControlLogixNet
{
    ...
    public sealed class LogixProcessor : IDevice
    {
        ...
        public bool Connect()
        {
            ...
            {
                _initializing = true;                                                                            
                _session = SessionManager.CreateAndRegister(_ipAddress, 0xAF12, System.Text.ASCIIEncoding.ASCII.GetBytes("KSociety"));
        ...
        public bool ReadTag(ITag tag)
        {
            lock (SyncRoot)
            {
                ...
                ReadDataServiceReply lgxRead = LogixServices.ReadLogixData(_session, lgxTag.Address, (ushort)lgxTag.Elements, SyncRoot); //ToDo SyncRoot
                ...
                if (lgxRead.Status == 0x06)
                {
                    ...
                    {
                        lgxRead = LogixServices.ReadLogixDataFragmented(_session, lgxTag.Address, (ushort)lgxTag.Elements, offset, SyncRoot); //ToDo SyncRoot
                        lgxTag.SetTagError(lgxRead.ByteStatus);
        ...
        public bool ReadTagFragment(ITag tag)
        {
            lock (SyncRoot)
            {
                ...
                ReadDataServiceReply lgxRead = LogixServices.ReadLogixDataFragment(_session, lgxTag.Address, (ushort)lgxTag.Elements, SyncRoot); //ToDo SyncRoot
        ...
        public bool WriteTag(ITag tag)
        {
            lock (SyncRoot)
            {
                ...
                WriteDataServiceReply lgxWrite = LogixServices.WriteLogixData(_session, lgxTag.Address, lgxTag.DataType, (ushort)lgxTag.Elements, lgxTag.GetWriteData(), SyncRoot, lgxTag.StructHandle); //ToDo SyncRoot
        ...
        public void SetRunMode()
        {
            //lock (_lockObject)
            {
                ...
                cpf.DataItem = CommonPacketItem.GetConnectedDataItem(request, SequenceNumberGenerator.SequenceNumber(SyncRoot));
