...
namespace KSociety.Com.Driver.Enip.Eipnet.Eip
{
    public class SessionManager
    {
        ...
        public static SessionInfo CreateAndRegister(string hostNameOrIp, int port = 0xAF12, byte[] senderContext = null)
        {
            ...
            si.SessionSocket = new System.Net.Sockets.Socket(AddressFamily.InterNetwork, SocketType.Stream,
            ...
            try
            {
                si.TcpPing(hostNameOrIp, port);
            }
            catch (Exception e)
            {
                si.LastSessionErrorStack = e.StackTrace;
                si.LastSessionErrorString = e.Message;
                return si;
            }
            ...
            try
            {
                ...
                RegisterSessionReply registerReply = reply;
