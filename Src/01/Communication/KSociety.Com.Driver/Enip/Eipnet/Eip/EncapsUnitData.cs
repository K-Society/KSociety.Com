...
{
    public class EncapsUnitData : IPackable, IExpandable
    {
        ...
        /// <summary>
        /// Expands the DataArray into this EncapsUnitData object
        /// </summary>
        /// <param name="DataArray">Source array</param>
        /// <param name="Offset">Offset where the EncapsUnitData object starts</param>
        /// <param name="NewOffset">Offset where the EncapsUnitData object ends</param>
