...
namespace KSociety.Com.Driver.Modbus
{
    public class ModbusTAG
    {
        ...
        public int Value => GetDataInt();
        public int Value2 => GetDataInt2();
        ...
        private string GetDataString()
        {
            ...
            {
                /* Global.myLog.Log(5, " TAG GetString: " + ex.ToString()); */
            }
        ...
        private bool GetDataBit()
        {
            ...
            {
                /*Global.myLog.Log(5, " TAG GetData: " + ex.ToString()); word[0] = -1; */
            }
        ...
        public int GetDataInt2()
        {
            ...
            {
                /* Global.myLog.Log(5, " TAG GetData2: " + ex.ToString()); myWord[0] = -1;*/
            }
        ...
        private void MBmaster_OnException(ushort id, byte unit, byte function, byte exception)
        {
            ...
            switch (exception)
            {
                case Master.excIllegalFunction:
                    exc += "Illegal function!"; /*Global.errorModbus = false;*/
                    break;
                case Master.excIllegalDataAdr:
                    exc += "Illegal data adress!"; /*Global.errorModbus = false;*/
                    break;
                case Master.excIllegalDataVal:
                    exc += "Illegal data value!"; /*Global.errorModbus = false;*/
                    break;
                case Master.excSlaveDeviceFailure:
                    exc += "Slave device failure!"; /* Global.errorModbus = false;*/
                    break;
                case Master.excAck:
                    exc += "Acknoledge!"; /*Global.errorModbus = false;*/
                    break;
                case Master.excGatePathUnavailable:
                    exc += "Gateway path unavailbale!"; /*Global.errorModbus = false;*/
                    break;
                case Master.excExceptionTimeout:
                    exc += "Slave timed out!"; /* Global.errorModbus = false; */
                    break;
                case Master.excExceptionConnectionLost:
                    exc += "Connection is lost!"; /* Global.errorModbus = false; */
                    break;
                case Master.excExceptionNotConnected:
                    exc += "Not connected!"; /*Global.errorModbus = false;*/
                    break;
            }
