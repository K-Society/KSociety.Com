...
namespace KSociety.Com.Infra.DataAccess.Migrations
{
    ...
    [Migration("20201117123221_ComDb")]
    partial class ComDb
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entity.Common.AnalogDigital", b =>
                {
            ...
            modelBuilder.Entity("Domain.Entity.Common.AutomationType", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entity.Common.Bit", b =>
                {
            ...
            modelBuilder.Entity("Domain.Entity.Common.Connection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("Connection", "std");

                    b.HasDiscriminator<int>("AutomationTypeId").HasValue(0);
                });

            modelBuilder.Entity("Domain.Entity.Common.InOut", b =>
                {
            ...
            modelBuilder.Entity("Domain.Entity.Common.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entity.Common.TagGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entity.S7.Area", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entity.S7.BlockArea", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("S7BlockArea", "std");
                });

            modelBuilder.Entity("Domain.Entity.S7.ConnectionType", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.ToTable("S7ConnectionType", "std");
            ...
            modelBuilder.Entity("Domain.Entity.S7.CpuType", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entity.S7.WordLen", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entity.View.Common.TagGroupReady", b =>
                {
                    b.Property<int>("Clock")
                        .HasColumnType("int");
                    ...
                    b.ToView("TagGroupReadyView", "std");
                });

            modelBuilder.Entity("Domain.Entity.View.Joined.AllConnection", b =>
                {
                    ...
                    b.ToView("AllConnectionView", "std");
                });

            modelBuilder.Entity("Domain.Entity.View.Joined.AllTagGroupAllConnection", b =>
                {
                    b.Property<string>("AnalogDigitalSignal")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToView("AllTagGroupAllConnectionView", "std");
                });

            modelBuilder.Entity("Domain.Entity.View.Joined.AllTagGroupConnection", b =>
                {
                    b.Property<string>("AnalogDigitalSignal")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToView("AllTagGroupConnectionView", "std");
                });

            modelBuilder.Entity("Domain.Entity.Logix.LogixConnection", b =>
                {
                    b.HasBaseType("Domain.Entity.Common.Connection");
            ...
            modelBuilder.Entity("Domain.Entity.Modbus.ModbusConnection", b =>
                {
                    b.HasBaseType("Domain.Entity.Common.Connection");
            ...
            modelBuilder.Entity("Domain.Entity.S7.S7Connection", b =>
                {
                    b.HasBaseType("Domain.Entity.Common.Connection");
            ...
            modelBuilder.Entity("Domain.Entity.Tcp.TcpConnection", b =>
                {
                    b.HasBaseType("Domain.Entity.Common.Connection");
            ...
            modelBuilder.Entity("Domain.Entity.Logix.LogixTag", b =>
                {
                    b.HasBaseType("Domain.Entity.Common.Tag");

                    b.HasDiscriminator().HasValue(2);
                });

            modelBuilder.Entity("Domain.Entity.Modbus.ModbusTag", b =>
                {
                    b.HasBaseType("Domain.Entity.Common.Tag");
            ...
            modelBuilder.Entity("Domain.Entity.S7.S7Tag", b =>
                {
                    b.HasBaseType("Domain.Entity.Common.Tag");
            ...
            modelBuilder.Entity("Domain.Entity.Tcp.TcpTag", b =>
                {
                    b.HasBaseType("Domain.Entity.Common.Tag");
            ...
            modelBuilder.Entity("Domain.Entity.Common.Connection", b =>
                {
                    b.HasOne("Domain.Entity.Common.AutomationType", "AutomationType")
            ...
            modelBuilder.Entity("Domain.Entity.Common.Tag", b =>
                {
                    b.HasOne("Domain.Entity.Common.AnalogDigital", "AnalogDigital")
                        .WithMany("Tags")
                    ...
                    b.HasOne("Domain.Entity.Common.Connection", "Connection")
                        .WithMany("Tags")
                    ...
                    b.HasOne("Domain.Entity.Common.InOut", "InOut")
                        .WithMany("Tags")
                    ...
                    b.HasOne("Domain.Entity.Common.TagGroup", "TagGroup")
                        .WithMany("Tags")
            ...
            modelBuilder.Entity("Domain.Entity.S7.BlockArea", b =>
                {
                    b.HasOne("Domain.Entity.S7.Area", "Area")
                    ...
                    b.HasOne("Domain.Entity.S7.S7Connection", "Connection")
                        .WithMany()
                        .HasForeignKey("ConnectionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entity.S7.WordLen", "WordLen")
                        .WithMany("S7BlockAreas")
            ...
            modelBuilder.Entity("Domain.Entity.S7.S7Connection", b =>
                {
                    b.HasOne("Domain.Entity.S7.ConnectionType", "ConnectionType")
                        .WithMany("Connections")
                        .HasForeignKey("ConnectionTypeId")
                        .HasConstraintName("ForeignKey_S7Connection_S7ConnectionType");

                    b.HasOne("Domain.Entity.S7.CpuType", "CpuType")
            ...
            modelBuilder.Entity("Domain.Entity.S7.S7Tag", b =>
                {
                    ...
                    b.HasOne("Domain.Entity.Common.Bit", "Bit")
                        .WithMany("S7Tags")
